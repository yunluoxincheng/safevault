...
| `SafeVault 开发文档.md` | Legacy high-level Chinese docs | Historical, partially stale | Move to `docs/plans/legacy-root-docs/` and leave pointer |
| `SafeVault 开发文档前端.md` | Legacy frontend Chinese docs | Historical, partially stale | Move to `docs/plans/legacy-root-docs/` and leave pointer |
| `SafeVault 开发文档后端.md` | Legacy backend Chinese docs | Historical, partially stale | Move to `docs/plans/legacy-root-docs/` and leave pointer |
| `图标映射清单.md` | Legacy design reference | Historical | Move to `docs/plans/legacy-root-docs/` and leave pointer |
